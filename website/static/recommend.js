$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api = "e7163087b3bbe3d05267077a845f43b9";
    var title = $('.movie').val();
    if (title=="") {
...
function load_details(my_api,title){
  $.ajax({
    type: 'GET',
    url:'https://api.themoviedb.org/3/search/movie?api_key='+my_api+'&query='+title,
    ...
    success: function(movie){
      if(movie.results.length<1){
        ...
        movie_recs(movie_title,movie_id,my_api);
      }
    },
    error: function(){
